...
SELECTED_ALGOS=()
SELECTED_THRESHOLDS=()
ALGO_TIMEOUT_SECONDS="${ALGO_TIMEOUT_SECONDS:-300}"
LOAD_TIMEOUT_SECONDS="${LOAD_TIMEOUT_SECONDS:-100}"
PARALLEL_JOBS=1
...
Environment:
  ALGO_TIMEOUT_SECONDS     Algorithm timeout after graph loading. Default: 300.
