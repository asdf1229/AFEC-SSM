#ifndef MATCHING_ALGORITHMS_CDE_BLACK_WHITE_SPLIT_H_
#define MATCHING_ALGORITHMS_CDE_BLACK_WHITE_SPLIT_H_
...
#endif // CDE_BLACK_WHITE_ENABLE_SPLIT

} // namespace cde_black_white

#endif // MATCHING_ALGORITHMS_CDE_BLACK_WHITE_SPLIT_H_
