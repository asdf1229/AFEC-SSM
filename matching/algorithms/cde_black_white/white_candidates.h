...
#error "This internal header must be included from cde_black_white/context.h inside Workspace."
    ...
    bool calcBlackDelta(const SearchState &state, ui u, ui v,
        ui cost, ui &delta)
    {
    ...
    void addFeasibleCand(const SearchState &state, ui u,
    ...
    void addFeasibleBatch(const SearchState &state, ui u,
    ...
    void addBucketCands(const SearchState &state,
    ...
    bool refreshWhiteCands(SearchState &state,
        ui white_u, ui cost)
    {
    ...
    bool refreshWhiteByBlack(SearchState &state, ui white_u,
